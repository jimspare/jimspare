        ...
        <section className="mt-12 grid grid-cols-1 gap-8 sm:mt-16 md:grid-cols-[200px_1fr] md:gap-12 lg:grid-cols-[240px_1fr] lg:gap-16">
          ...
          >
            ...
            <p>
              ...
              creation of a $250 million joint venture with <strong className="font-bold text-foreground">Walmart</strong>. Earlier in his
              career, he served as CEO of <strong className="font-bold text-foreground">Canesta</strong> through its acquisition by
              <strong className="font-bold text-foreground"> Microsoft</strong>, where its technology later contributed to products
              including Xbox Kinect and HoloLens.
            </p>
            <p>
              Throughout his career, Jim has worked with leading strategic and
              financial partners including <strong className="font-bold text-foreground">Walmart</strong>, <strong className="font-bold text-foreground">Microsoft</strong>, <strong className="font-bold text-foreground">Intel</strong>, <strong className="font-bold text-foreground">Samsung</strong>, <strong className="font-bold text-foreground">Sony</strong>,
              <strong className="font-bold text-foreground"> Honda</strong>, <strong className="font-bold text-foreground">Sequoia</strong>, <strong className="font-bold text-foreground">NEA</strong>, <strong className="font-bold text-foreground">Venrock</strong>, and <strong className="font-bold text-foreground">The Carlyle Group</strong>. He has also
              served on the boards of companies acquired by organizations including
              <strong className="font-bold text-foreground"> Morgan Stanley</strong>, <strong className="font-bold text-foreground">Microsoft</strong>, <strong className="font-bold text-foreground">Twitter</strong>, and <strong className="font-bold text-foreground">Foxconn</strong>.
            </p>
