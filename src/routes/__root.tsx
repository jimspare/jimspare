...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Jim Spare is a strategic transformation leader for AI-era enterprise software businesses." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Jim Spare | Strategic growth leader." },
      { property: "og:description", content: "Jim Spare is a strategic transformation leader for AI-era enterprise software businesses." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bungee+Inline&family=Inter:wght@400;500;700&family=Montserrat:ital,wght@0,400;0,600;1,800&display=swap",
      },
    ],
    scripts: [
      {
